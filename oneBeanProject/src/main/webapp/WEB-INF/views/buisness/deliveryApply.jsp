...
<link href="<%=request.getContextPath() %>/css/buisness/deliveryApply.css" rel="stylesheet" />
...
<section>
    ...
    <img class="img1" src="<%=request.getContextPath() %>/images/필독.jpg"><br><br>
    ...
    <img class="image1" src="<%=request.getContextPath() %>/images/박스.jpg"><br>
    <span class="subject2">#대표_블랜딩_3종</span>
	<div>
	    <img class="img1" src="<%=request.getContextPath() %>/images/샘플3종.jpg">
	</div>
    <form name="frm" action="<%=request.getContextPath() %>/Buisness/deliveryApply.do" method="post" class="b-frm">
