...
<link href="<%=request.getContextPath() %>/css/buisness/newShopQuestion.css" rel="stylesheet" />
...
<section id="section">
<img class="title_image" src="<%=request.getContextPath() %>/images/창업문의.png">
	<form method="post" action="<%=request.getContextPath() %>/Buisness/newShopQuestion.do">
