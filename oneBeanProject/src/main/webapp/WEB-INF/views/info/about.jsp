...
<body>
	<header class="fixed-top">
		...
		<nav class="navigation">
			...
			<ul id="right_nav">
				<li class="icon"><a href="#"><i class="bi bi-person" style="font-size: 30px;"></i></a>
					<ul class="under_view">
						<!-- 로그인 안했을때 -->
				...
				<div class="col-lg-5 col-md-6 col-sm-12 col-xs-12">
					<div>
						...
						<p>
							...
							11111111<br> 통신판매업 신고 2020-용인기흥-1464호 &nbsp;&nbsp;&nbsp;<a href="#">[사업자정보확인]</a><br> 주소 전라북도 전주시 덕진구 백제대로 572 5층 503호<br>
