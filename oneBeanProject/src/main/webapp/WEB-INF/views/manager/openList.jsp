...
<script type="text/javascript">
	function changeCall(openIdx,obj) {
		...
		location.href='<%=request.getContextPath() %>/Manager/changeCall.do?openIdx='+openIdx+"&openCallYN="+value;
	}
</script>
</head>
<body>
...
<section>
	<img class="title_image" src="<%=request.getContextPath() %>/images/openQList.png">
