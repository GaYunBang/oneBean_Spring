...
<link href="<%=request.getContextPath() %>/css/member/memAddr.css" rel="stylesheet" />
...
<section id="section">
	...
	<div class="create">
		<input class="but4" type="button" value="수정하기" onclick="location.href='<%=request.getContextPath() %>/Member/addrListModify.do'">
	</div>
</section>
