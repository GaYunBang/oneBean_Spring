...
<link href="<%=request.getContextPath() %>/css/member/memInfo.css" rel="stylesheet" />
...
<section id="section">
<img class="title_image" src="<%=request.getContextPath() %>/images/memInfoLogo.png">
        <form method="post" action="">
          ...
          <div class="create">
            <a href="<%=request.getContextPath() %>/Member/memInfoModify.do?midx=${midx}"><input class="but4" type="button" value="수정하기"></a>      
          </div>
          </div>
          </form>
    </section>
