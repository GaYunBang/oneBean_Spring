...
<link href="<%=request.getContextPath() %>/css/regular/regList.css" rel="stylesheet" />
...
<section>
	<img class="title_image" src="<%=request.getContextPath() %>/images/regular_sub.png">
	   <form name="subs_form" method="post" action ="">
            <table id="productInfo">
                <thead>
                    <tr>
                        <th style="width: 20%;">시작일</th>
                        <th style="width: 20%;">최근결제일</th>
                        <th class="pr_info" style="width: 40%;">구독정보</th>
                        <th style="width: 20%;">구독취소</th>
                    </tr>
                </thead>
                <tbody>
                <c:forEach var="list" items="${list}">
                    <tr>
                        <td>${list.regStartDay}</td>
                        <td>${list.regPayDay}</td>
                        <td>${list.regName}</td>
                        <td><input class="sub_esc" type="button" value="구독취소" onclick=""></td>            
                    </tr>
                    </c:forEach>
                </tbody>
            </table>                                                                                                                                                                                                                                                                                                                                
