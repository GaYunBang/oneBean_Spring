...
<link href="<%=request.getContextPath() %>/css/product/newProduct.css" rel="stylesheet" />
...
<script type="text/javascript">
	function goDetail(idx) {
		location.href="<%=request.getContextPath() %>/Product/proDetail.do?proIdx="+idx;
	}
</script>
</head>
<body>
...
<section>
	<img class="newImg" alt="" src="<%=request.getContextPath() %>${vo.newProThumb}" onclick="goDetail(${vo.proIdx})">
</section>
<footer class="footer">
	<div class="container">
