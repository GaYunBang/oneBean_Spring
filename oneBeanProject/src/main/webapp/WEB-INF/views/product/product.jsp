...
<body>
    ...
    <div class="box">
        ...
        <div class="box_item p1">
            <img class="img" href="detale.html" src="/images/상품.png">
            <div>
            오리진 싱글<br>
            판매가 : 8,000원(100g 기준)<br>
            산미가 없는 적당히 풍부한 맛의 원두
            </div>
        </div>
        </a>
        <a href="product_detail.html">
        <div class="box_item p2">
            <img class="img" src="/images/상품.png">
            <div>
                오리진 싱글<br>
                판매가 : 8,000원(100g 기준)<br>
                산미가 없는 적당히 풍부한 맛의 원두
