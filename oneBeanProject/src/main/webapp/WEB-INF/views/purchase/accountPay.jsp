...
<link href="/css/purchase/accountPay.css" rel="stylesheet" />
...
<section>
	<div class="container">
		<div class="insert">
			<table>
				<caption><img src="/images/무통.png"></caption>
				<tr>
					<td class="col1">입금자</td>
					<td class="col2">
						<input type="text" class="deco1" name="memberName" value="${pay.payName }" maxlength="5" readonly>
					</td>
				</tr>
				<tr>
					<td class="col1">입금기한</td>
					<td class="col2">
						<fmt:parseDate value="${pay.payDate }" var="parseDateValue" pattern="yyyy-MM-dd HH:ss"/>
						<fmt:formatDate value="${parseDateValue }" pattern="yyyy-MM-dd"/> 23:59:59
					</td>
				</tr>
				<tr>
					<td class="col1">입금가격</td>
					<td class="col2">
						<fmt:formatNumber value="${pay.payTotalPrice }" pattern="###,###,### 원" />
					</td>
				</tr>
				<tr>
					<td class="col1">입금계좌</td>
					<td class="col2">
						<input type="text" class="deco1" value="카카오뱅크 333-44444444-12-4 (예금주:원빈커피)">
					</td>
				</tr>
			</table>
		</div>
