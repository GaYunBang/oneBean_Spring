...
<script type="text/javascript">
	...
	//주문자와 동일 버튼 눌렀을 때
	function sameShip(){
		var name = $("input[name='regPayName']").val();
		var phone = $("input[name='regPayPhone']").val();
		$("input[name='regPostName']").val(name);
		$("input[name='regPostPhone']").val(phone);
	}
	...
	<form name="order_form" method="post" action="regularPay.do" onsubmit="requestPay();return false;">
		<div class="content pt-4">
			<div class="container-xxl">
				...
				<tbody>
				<input type="hidden" value="${vo.regIdx }" name="regIdx">
				<tr class="shop_box2">
					<td class="sum_box">
						<img src="<%=request.getContextPath() %>${vo.regImg }" width="80px">
					</td>
					<td class="con_box">
						<span class="pro">${vo.regName }<br>${vo.regContents }</span>
					</td>
					<td class="top_3">
				...
				<div class="shop_box mt-2 py-3">
					<div class="d-flex align-items-center pb-4">
						...
						<input type="text" class="order_txt" name="regPayName" value="${member.memberName}">
					</div>
					<div class="d-flex align-items-center pb-4">
						<span class="px-3 name_subject">휴대폰<span class="color_red">*</span></span>
						<input type="text" class="order_txt" name="regPayPhone" value="${member.memberPhone}">
					</div>
					<div class="d-flex align-items-center">
						<span class="px-3 name_subject">이메일<span class="color_red">*</span></span>
						<input type="text" class="order_txt" name="regPayEmail" value="${member.memberEmail}">
					</div>
				</div>
				...
				<div class="shop_box mt-2 py-3">
					...
					<div class="d-flex align-items-center pb-4">
						...
						<input type="text" class="order_txt" name="regPostName">
					</div>
					<div class="d-flex align-items-center pb-4">
						<span class="px-2 ms-1 px-sm-3 ms-sm-0  name_subject">휴대폰번호<span class="color_red">*</span></span>
						<input type="text" class="order_txt" name="regPostPhone">
					</div>
					<div class="d-flex align-items-center pb-4 row">
						...
						<div class="d-flex justify-content-center flex-column mb_address">
							...
							<input id="member_post"  class="order_txt" name="regPostNum" type="text" placeholder="우편 번호" readonly value="${addr.memberPostNum }">
							<input id="member_addr" class="order_txt" name="regPostAddr" type="text" placeholder="도로명주소/지번주소" readonly value="${addr.memberAddr }"><br>
							<input id="member_detail_addr" class="order_txt" name="regPostDetailAddr" type="text" placeholder="상세 주소를 입력해주세요." value="${addr.memberDetailAddr}">
						</div>
					</div>
				</div>
				...
				<div class="shop_box mt-2 py-3">
					...
					<div class="d-flex align-items-center">
						...
						<input type="text" class="order_txt" name="regPostMemo" placeholder="배송 메시지를 입력해 주세요.">
					</div>
				</div>
				...
				<div class="shop_box mt-2 py-3 mb-3">
					<div class="d-flex align-items-center">
						...
						<label class="pe-3 d-flex align-items-center"><input type="radio" name="regPayType" value="무통장입금" class="mx-2" id="mootong" checked> 무통장 입금</label>
						<label class="pe-3 d-flex align-items-center"><input type="radio" name="regPayType" value="신용카드" class="mx-2" id="scard"> 신용카드</label>
						<label class="pe-3 d-flex align-items-center"><input type="radio" name="regPayType" value="계좌이체" class="mx-2" id="eche"> 계좌이체</label>
					</div>
				</div>
				<div id="checkWrap">
